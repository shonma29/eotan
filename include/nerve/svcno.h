...
#define SVC_KERNLOG (22)
#define SVC_REGION_CREATE (23)
#define SVC_REGION_DESTROY (24)
#define SVC_REGION_MAP (25)
#define SVC_REGION_UNMAP (26)
#define SVC_REGION_DUPLICATE (27)
#define SVC_REGION_PUT (28)
#define SVC_REGION_GET (29)
#define SVC_REGION_GET_STATUS (30)
