...
#define SVC_MPU_COPY_STACK (33)
#define SVC_MPU_SET_CONTEXT (34)
#define SVC_MPU_USE_FLOAT (35)
#define SVC_PORT_CREATE (36)
#define SVC_PORT_CREATE_AUTO (37)
#define SVC_PORT_DESTROY (38)
#define SVC_PORT_CALL (39)
#define SVC_PORT_ACCEPT (40)
#define SVC_PORT_REPLY (41)
