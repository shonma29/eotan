...
#define SYS_DIS_INT   	(28)
#define SYS_ENA_INT   	(29)

#define SYS_SET_TIM	(30)
#define SYS_GET_TIM	(31)
#define SYS_DLY_TSK	(32)

#define SYS_DEF_ALM	(33)

#define SYS_DEF_INT	(34)

#define SYS_VSYS_INF	(35)
#define SYS_DBG_PUTS	(36)

#define SYS_VCRE_REG	(37)
#define SYS_VDEL_REG	(38)
#define SYS_VMAP_REG	(39)
#define SYS_VUNM_REG	(40)
#define SYS_VDUP_REG	(41)
#define SYS_VPRT_REG	(42)
#define SYS_VSHR_REG	(43)
#define SYS_VPUT_REG	(44)
#define SYS_VGET_REG	(45)
#define SYS_VSTS_REG	(46)

#define SYS_VGET_PHS	(47)

#define SYS_VSYS_MSC	(48)
#define SYS_VCPY_STK	(49)
