...
/*
static const char RCSid[] = "$Header: /usr/local/src/master/B-Free/Program/btron-pc/kernel/BTRON/device/aha152x/hosts.c,v 1.1 2000/01/25 16:05:52 kishida0 Exp $";
*/
