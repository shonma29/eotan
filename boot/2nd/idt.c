 ...
 * idt.c
 *
 * $Header: /usr/local/src/master/B-Free/Program/btron-pc/boot/2nd/idt.c,v 1.3 1998/11/20 08:02:30 monaka Exp $
 *
 * $Log: idt.c,v $
...
static char	rcsid[] = "$Header: /usr/local/src/master/B-Free/Program/btron-pc/boot/2nd/idt.c,v 1.3 1998/11/20 08:02:30 monaka Exp $";
