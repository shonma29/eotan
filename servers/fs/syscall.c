...
struct posix_syscall	syscall_table[] =
{
  ...
  { "pause",		PSC_PAUSE,		psc_noaction_f },
  { "sigaction",	PSC_SIGACTION,		psc_noaction_f },
  { "sigreturn", 	PSC_SIGRETURN,		psc_noaction_f },
  { "sigprocmask",	PSC_SIGPROCMASK,	psc_noaction_f },
  { "sigpending",	PSC_SIGPENDING,		psc_noaction_f },
  { "sigsuspend",	PSC_SIGSUSPEND,		psc_noaction_f },
  { "sigaddset",	PSC_SIGADDSET,		psc_noaction_f },
  { "sigdelset",	PSC_SIGDELSET,		psc_noaction_f },
  { "sigemptyset",	PSC_SIGEMPTYSET,	psc_noaction_f },
  { "sigfillset",	PSC_SIGFILLSET,		psc_noaction_f },
  { "sigismember",	PSC_SIGISMEMBER,	psc_noaction_f },
  { "siglongjmp",	PSC_SIGLONGJMP,		psc_noaction_f },
  { "sigsetjmp",	PSC_SIGSETJMP,		psc_noaction_f },
  { "misc",		PSC_MISC,		psc_misc_f },
  { "memory",		PSC_MEMORY,		psc_noaction_f },
